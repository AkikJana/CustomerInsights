...
def stage_2_features_generation(bert_feature, 
                                attention_mask, 
                                spans, 
                                span_mask, 
                                spans_embedding, 
    ...
    for i, spans_aspect_tensor_unspilt in enumerate(spans_aspect_tensor_spilt):
        ...
        if all_span_aspect_tensor is None:
            ...
            try:
                ...
                all_span_aspect_tensor = torch.cat((all_span_aspect_tensor, aspect_span_embedding_unspilt[:,1]), dim=0)
...
class Step_1(torch.nn.Module):
    ...
    def forward(self, input_bert_features, attention_mask, spans, span_mask, related_spans_tensor, sentence_length):
        ...
        return class_logits_aspect, class_logits_opinion, spans_embedding, span_embedding_1, span_embedding_2, features_mask_tensor
